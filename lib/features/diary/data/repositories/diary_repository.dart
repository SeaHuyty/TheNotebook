class DiaryRepository {
  List<Map<String, dynamic>> getDiaryEntries() {
    return [
      // November 2025
      {
      ...
      // June 2025
      {
        ...
        'content':
            'Graduated from my online course! Hard work finally paid off.',
      ...
      },
      {
        ...
        'content':
            'Spring cleaning done! House feels fresh and organized again.',
        'imageUrl': null,
      },
      {
